  	...
  	<div class="home">
		<div class="w-full h-screen">
			<div class="w-full h-full">
				<img src="/images/header-slider-3.jpg" alt=""
		...
		<div class="bg-white py-20 px-10">
			<div class="max-w-4xl mx-auto">
				...
				<div class="mt-10 mb-0 md:mb-20 pt-6 flex flex-col md:flex-row justify-between">
					...
					<div class="">
						<router-link to="/releases" class="w-full md:w-auto block bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold font-bold py-2 px-3 border border-gray-900 rounded shadow rounded text-center">
		...
		<div class="bg-gray-100 py-20 px-10">
			<div class="max-w-4xl mx-auto">
				...
				<div class="flex flex-col md:flex-row justify-start mb-20 md:-ml-6" v-else>
					<div class="w-full md:w-1/3 mt-6 md:mt-0 md:ml-6" v-for="(post, postIndex) in posts" :key="postIndex">
