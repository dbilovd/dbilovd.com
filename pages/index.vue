    ...
    <div class="bg-gray-100 py-20 px-10">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-10 mb-0 md:mb-20 pt-6 flex flex-col md:flex-row justify-between">
          ...
          <div class="">
            <nuxt-link to="/releases" class="w-full md:w-auto block bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold font-bold py-2 px-3 border border-gray-900 rounded shadow rounded text-center">
